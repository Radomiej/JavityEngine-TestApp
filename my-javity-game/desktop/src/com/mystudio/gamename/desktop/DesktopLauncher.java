...
import pl.radomiej.dungeon.DungeonCrawderScene;
import pl.silver.canvas.libgdx.SilverGdxCanvasApp;
...
//		new LwjglApplication(new SilverGdxCanvasApp(), config);
		new LwjglApplication(new JavityApplication(new DungeonCrawderScene()), config);
